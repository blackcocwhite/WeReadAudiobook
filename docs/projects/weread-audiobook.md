...
## Best Search Queries This Page Should Answer

- macOS WeRead audiobook app
- WeRead OCR TTS page turning app
- local PaddleOCR WeRead reader
- Swift menu bar app for reading WeRead aloud
- WeReadAudiobook project
